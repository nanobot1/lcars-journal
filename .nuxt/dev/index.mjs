...
import { renderToString } from 'file:///Users/marclange/Sites/node_vue/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/marclange/Sites/node_vue/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/marclange/Sites/node_vue/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/marclange/Sites/node_vue/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/marclange/Sites/node_vue/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/marclange/Sites/node_vue/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/marclange/Sites/node_vue/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/marclange/Sites/node_vue/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/marclange/Sites/node_vue/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/marclange/Sites/node_vue/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/marclange/Sites/node_vue/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/marclange/Sites/node_vue/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/marclange/Sites/node_vue/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/marclange/Sites/node_vue/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/marclange/Sites/node_vue/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/marclange/Sites/node_vue/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/marclange/Sites/node_vue/node_modules/source-map/source-map.js';
...
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/marclange/Sites/node_vue/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/marclange/Sites/node_vue/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/marclange/Sites/node_vue/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marclange/Sites/node_vue","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marclange/Sites/node_vue/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marclange/Sites/node_vue/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marclange/Sites/node_vue/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marclange/Sites/node_vue/.data/kv"}));
...
const _AtktL2bNW1vS6qyvFdtSyOZv9T2b_wa1n8K1OWnvsBQ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/marclange/Sites/node_vue";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Ein persönlicher Arbeitsbereich im LCARS Stil"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Orbitron:wght@400;700&display=swap"}],"style":[],"script":[],"noscript":[],"title":"LCARS Journal & Todo"};
...
const _21PBNGOMK7LmsNy7OofIOQMygE5JwfkEsFcdMQRlA = (nitroApp) => {
...
const plugins = [
  _AtktL2bNW1vS6qyvFdtSyOZv9T2b_wa1n8K1OWnvsBQ,
...
const _gRq6E1 = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/marclange/Sites/node_vue/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/marclange/Sites/node_vue/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_b8y6L7 = () => Promise.resolve().then(function () { return health_get$1; });
const _lazy_0tj6En = () => Promise.resolve().then(function () { return _id__delete$3; });
const _lazy_OCDtsM = () => Promise.resolve().then(function () { return _id__put$3; });
const _lazy_3HsEEh = () => Promise.resolve().then(function () { return todos_get$1; });
const _lazy_Yc0eZS = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_FNOGIn = () => Promise.resolve().then(function () { return index_post$3; });
const _lazy_pv5DdX = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_LnxIQA = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_IqUmGr = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_2CYhQY = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_l9ocRi = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _gRq6E1, lazy: false, middleware: true, method: undefined },
  { route: '/api/health', handler: _lazy_b8y6L7, lazy: true, middleware: false, method: "get" },
  { route: '/api/journals/:id', handler: _lazy_0tj6En, lazy: true, middleware: false, method: "delete" },
  { route: '/api/journals/:id', handler: _lazy_OCDtsM, lazy: true, middleware: false, method: "put" },
  { route: '/api/journals/:id/todos', handler: _lazy_3HsEEh, lazy: true, middleware: false, method: "get" },
  { route: '/api/journals', handler: _lazy_Yc0eZS, lazy: true, middleware: false, method: "get" },
  { route: '/api/journals', handler: _lazy_FNOGIn, lazy: true, middleware: false, method: "post" },
  { route: '/api/todos/:id', handler: _lazy_pv5DdX, lazy: true, middleware: false, method: "delete" },
  { route: '/api/todos/:id', handler: _lazy_LnxIQA, lazy: true, middleware: false, method: "put" },
  { route: '/api/todos', handler: _lazy_IqUmGr, lazy: true, middleware: false, method: "get" },
  { route: '/api/todos', handler: _lazy_2CYhQY, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_l9ocRi, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_l9ocRi, lazy: true, middleware: false, method: undefined }
];
...
const todos_get = defineEventHandler(async (event) => {
  try {
    const id = Number(getRouterParam(event, "id"));
...
const todos_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: todos_get
}, Symbol.toStringTag, { value: 'Module' }));
